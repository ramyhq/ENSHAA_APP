...
class UserRequestPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<Request>?>.value(
      value: DatabaseServices().RequestsDataListOnlyMyUser(customer_email.toString()),
      initialData: null,
      child: Scaffold(
        appBar: AppBar(
          ...
          child: Column(
            children:  [
              ...
              Container(
                ...
                height: 70,
                child: const Text("My Requests",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),textAlign: TextAlign.center,),
              ),
                    ...
                    GFButton(
                      onPressed: ()async {
                        showAlertDialog(
                            ...
                            function: () async {
                              try {
                                await DatabaseServices().DeleteRequestData(
                                  request_id: request.request_id.toString(),
                                );
                              } catch (e) {
                                print('#DeleteRequestData error : $e');
                              }
                            }
                        );
                      },
